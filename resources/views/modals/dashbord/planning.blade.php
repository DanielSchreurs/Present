<section class="box">
    ...
    @if(empty(\Auth::user()->cours->toArray()))
        <div class="box__item--small" data-intro="Créer un nouveau cours ici" data-step="4">
                ...
                <div class="box__item__actions">
                    @if($occurrence->is_closed=='0')
                        <div data-toggle="tooltip"
                             data-title="Prendre les présences du {!! $occurrence->from->formatLocalized('%a, %e %b %Y') !!} à {{$occurrence->from_hour->formatLocalized('%H:%M')}}"
                             class="svg-container">
                            <svg class="svg-basic svg--blue">
